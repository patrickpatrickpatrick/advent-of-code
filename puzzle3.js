...
const filteredInput = processedInput.filter(x => {
	const matches = Array.from(x[2].matchAll(x[1]))
	return (matches.length >= x[0][0] && matches.length <= x[0][1]);
});
